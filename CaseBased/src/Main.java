...
public class Main {
    ...
    public static void main(String[] args) {
    	...
    	DiagnosisApplication diagnosisApplication = new DiagnosisApplication();
       	...
       	diagnosisApplication.run(Arrays.asList("arm_pain","knee_pain", "ankle_pain","arm_swelling","ankle_swelling","wrist_stiffnes_or_tightness"));

		
		  MedicamentApplication medicamentApplication = new MedicamentApplication();
		  medicamentApplication.run(Arrays.asList("ketamine","flumazenil","fluorides","fenoprofen","plasma_protein_fraction")); // ProceduresCbrApplication pca =
		  ...
		  symptomeApplication.run(Arrays.asList("bruise","sprain_or_strain", "fracture_of_the_arm","injury_to_the_shoulder","spinal_stenosis",
		  "brachial_neuritis","pyogenic_skin_infection","carpal_tunel_syndrome"));
		    }
