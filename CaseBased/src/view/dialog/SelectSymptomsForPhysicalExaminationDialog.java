...
public class SelectSymptomsForPhysicalExaminationDialog extends JDialog{
	...
	public void initComponents(){
		...
		setTitle("Dodavanje novih simptoma");
		setModal(true);
		...
		
		{
			...
			{
				infoLabel = new JLabel("Odaberite simptome iz spiska dostupnih:");
		...
		
		{
			...
			mainPanel.setLayout(new GridLayout(0, 2, 0, 0));
			{
				...
				leftPanel.setLayout(new BorderLayout(0, 0));
				{
					...
					{
						infoLeftLabel = new JLabel("Odaberite neki od mogucih simptoma:");
			...
			}
			{
				...
				rightPanel.setLayout(new BorderLayout(0, 0));
				{
					...
					{
						infoRightLabel = new JLabel("Trenutno odabrani simptomi");
